...
- [F.0.1 - Contextual Lexicon Principles](#f01---contextual-lexicon-principles)
  - [F.0.1:1 - Problem Frame](#f011---problem-frame)
  - [F.0.1:2 - The Three Principles (normative)](#f012---the-three-principles-normative)
  - [F.0.1:3 - Minimal Artefacts (conceptual, notationally neutral)](#f013---minimal-artefacts-conceptual-notationally-neutral)
  - [F.0.1:4 - Invariants (normative)](#f014---invariants-normative)
  - [F.0.1:5 - Reasoning Primitives (judgement schemata; pure, side‑effect‑free)](#f015---reasoning-primitives-judgement-schemata-pure-sideeffectfree)
  - [F.0.1:6 - Didactic Metaphor (informative)](#f016---didactic-metaphor-informative)
  - [F.0.1:7 - Placement & Flow](#f017---placement-flow)
  - [F.0.1:8 - Anti‑patterns & remedies](#f018---antipatterns-remedies)
  - [F.0.1:9 - Compact worked examples](#f019---compact-worked-examples)
  - [F.0.1:10 - Extended reasoning moves (pure judgement schemata)](#f0110---extended-reasoning-moves-pure-judgement-schemata)
  - [F.0.1:11 - SCR/RSCR acceptance checks (conceptual)](#f0111---scrrscr-acceptance-checks-conceptual)
  - [F.0.1:12 - Quick reference (didactic)](#f0112---quick-reference-didactic)
  - [F.0.1:End](#f01end)
- [F.1 - Domain‑Family Landscape Survey](#f1---domainfamily-landscape-survey)
  - [F.1:1 - Intent & applicability](#f11---intent-applicability)
  - [F.1:2 - Problem frame](#f12---problem-frame)
  - [F.1:3 - Forces](#f13---forces)
  - [F.1:4 - Core idea (didactic)](#f14---core-idea-didactic)
  - [F.1:5 - Minimal vocabulary (this pattern only)](#f15---minimal-vocabulary-this-pattern-only)
  - [F.1:6 - Solution — the Contexts‑first survey (conceptual, notation‑free)](#f16---solution-the-contextsfirst-survey-conceptual-notationfree)
  - [F.1:7 - What to record (conceptual, not clerical)](#f17---what-to-record-conceptual-not-clerical)
  - [F.1:8 - Invariants (normative, lightweight)](#f18---invariants-normative-lightweight)
  - [F.1:9 - Self‑checks (mental, not procedural)](#f19---selfchecks-mental-not-procedural)
  - [F.1:10 - Micro‑examples (illustrative only)](#f110---microexamples-illustrative-only)
  - [F.1:11 - Anti‑patterns & remedies](#f111---antipatterns-remedies)
  - [F.1:12 - Worked examples](#f112---worked-examples)
  - [F.1:13 - Reasoning primitives (judgement schemas, notation‑free)](#f113---reasoning-primitives-judgement-schemas-notationfree)
  - [F.1:14 - F1‑Card example (informative)](#f114---f1card-example-informative)
  - [F.1:15 - Relations (with other patterns)](#f115---relations-with-other-patterns)
  - [F.1:16 - Migration notes (conceptual)](#f116---migration-notes-conceptual)
  - [F.1:17 - Acceptance tests (SCR/RSCR — concept‑level)](#f117---acceptance-tests-scrrscr-conceptlevel)
  - [F.1:18 - Didactic distillation (90‑second teaching script)](#f118---didactic-distillation-90second-teaching-script)
  - [F.1:End](#f1end)
- [F.2 — Term Harvesting & Normalisation](#f2-term-harvesting-normalisation)
  - [F.2:1 - Intent & applicability](#f21---intent-applicability)
  - [F.2:2 - Problem Frame](#f22---problem-frame)
  - [F.2:3 - Forces](#f23---forces)
  - [F.2:4 - Core idea (didactic)](#f24---core-idea-didactic)
  - [F.2:5 - Minimal vocabulary (this pattern only)](#f25---minimal-vocabulary-this-pattern-only)
  - [F.2:6 - Solution — three mental moves (notation‑free)](#f26---solution-three-mental-moves-notationfree)
  - [F.2:7 - Guard‑rails (normative, lightweight)](#f27---guardrails-normative-lightweight)
  - [F.2:8 - Micro‑examples (illustrative, context‑local)](#f28---microexamples-illustrative-contextlocal)
  - [F.2:9 - Didactic heuristics (informative)](#f29---didactic-heuristics-informative)
  - [F.2:10 - Anti‑patterns & remedies](#f210---antipatterns-remedies)
  - [F.2:11 - Worked examples (context‑local only)](#f211---worked-examples-contextlocal-only)
  - [F.2:12 - Reasoning primitives (judgement schemas, notation‑free)](#f212---reasoning-primitives-judgement-schemas-notationfree)
  - [F.2:13 - Relations](#f213---relations)
  - [F.2:14 - Migration notes (conceptual)](#f214---migration-notes-conceptual)
  - [F.2:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f215---acceptance-tests-scrrscr-conceptlevel)
  - [F.2:16 - Didactic distillation (60‑second script)](#f216---didactic-distillation-60second-script)
  - [F.2:End](#f2end)
- [F.3 - Intra‑Context Sense Clustering](#f3---intracontext-sense-clustering)
  - [F.3:1 - Intent & applicability](#f31---intent-applicability)
  - [F.3:2 - Problem Frame](#f32---problem-frame)
  - [F.3:3 - Forces](#f33---forces)
  - [F.3:4 - Core idea (didactic)](#f34---core-idea-didactic)
  - [F.3:5 - Minimal vocabulary (this pattern only)](#f35---minimal-vocabulary-this-pattern-only)
  - [F.3:6 - Solution — how to think the clustering (notation‑free)](#f36---solution-how-to-think-the-clustering-notationfree)
  - [F.3:7 - Outputs (conceptual, not clerical)](#f37---outputs-conceptual-not-clerical)
  - [F.3:8 - Invariants (normative, lightweight)](#f38---invariants-normative-lightweight)
  - [F.3:9 - Self‑checks (mental probes)](#f39---selfchecks-mental-probes)
  - [F.3:10 - Anti‑patterns & remedies](#f310---antipatterns-remedies)
  - [F.3:11 - Local‑Sense Cards (one‑glance form)](#f311---localsense-cards-oneglance-form)
  - [F.3:12 - Worked examples (all **intra‑Context**)](#f312---worked-examples-all-intracontext)
  - [F.3:13 - Reasoning primitives (judgement schemas, notation‑free)](#f313---reasoning-primitives-judgement-schemas-notationfree)
  - [F.3:14 - Relations](#f314---relations)
  - [F.3:15 - Migration notes (conceptual)](#f315---migration-notes-conceptual)
  - [F.3:16 - Acceptance tests (SCR/RSCR — concept‑level)](#f316---acceptance-tests-scrrscr-conceptlevel)
  - [F.3:17 - Didactic close (60‑second recap)](#f317---didactic-close-60second-recap)
  - [F.3:End](#f3end)
- [F.4 - Role Description (RCS + RoleStateGraph + Checklists)](#f4---role-description-rcs-rolestategraph-checklists)
  - [F.4:1 - Intent & applicability](#f41---intent-applicability)
  - [F.4:2 - Problem frame](#f42---problem-frame)
  - [F.4:3 - Forces](#f43---forces)
  - [F.4:4 - Minimal vocabulary (this pattern only)](#f44---minimal-vocabulary-this-pattern-only)
  - [F.4:5 - Core idea (didactic)](#f45---core-idea-didactic)
  - [F.4:6 - The Role Description Card (one‑screen sketch)](#f46---the-role-description-card-onescreen-sketch)
  - [F.4:7 - Normative invariants (template discipline)](#f47---normative-invariants-template-discipline)
  - [F.4:8 - Reasoning primitives (judgement schemas, notation‑free)](#f48---reasoning-primitives-judgement-schemas-notationfree)
  - [F.4:9 - Worked examples (Context‑true)](#f49---worked-examples-contexttrue)
  - [F.4:10 - Anti‑patterns & remedies](#f410---antipatterns-remedies)
  - [F.4:11 - Concept‑level operators (refinement & compatibility)](#f411---conceptlevel-operators-refinement-compatibility)
  - [F.4:11.7 - Cross‑context embargo (inside F.4)](#f4117---crosscontext-embargo-inside-f4)
  - [F.4:12 - Relations (where this card sits)](#f412---relations-where-this-card-sits)
  - [F.4:13 - Migration notes (conceptual playbook)](#f413---migration-notes-conceptual-playbook)
  - [F.4:14 - Acceptance tests (SCR/RSCR — concept‑level)](#f414---acceptance-tests-scrrscr-conceptlevel)
  - [F.4:15 - Didactic distillation (60‑second close)](#f415---didactic-distillation-60second-close)
  - [F.4:End](#f4end)
- [F.5 - Naming Discipline for U.Types & Roles](#f5---naming-discipline-for-utypes-roles)
  - [F.5:1 - Intent & applicability](#f51---intent-applicability)
  - [F.5:2 - Problem frame](#f52---problem-frame)
  - [F.5:3 - Minimal vocabulary (this pattern only)](#f53---minimal-vocabulary-this-pattern-only)
  - [F.5:4 - Core idea (didactic)](#f54---core-idea-didactic)
  - [F.5:5 - Normative rules — Role Descriptions (context‑local labels)](#f55---normative-rules-role-descriptions-contextlocal-labels)
  - [F.5:6 - Normative rules — U.Types (Cross‑context labels)](#f56---normative-rules-utypes-crosscontext-labels)
  - [F.5:7 - Twin rules](#f57---twin-rules)
  - [F.5:8 - Invariants (normative, lightweight)](#f58---invariants-normative-lightweight)
  - [F.5:9 - Reasoning primitives (judgement schemas, notation‑free)](#f59---reasoning-primitives-judgement-schemas-notationfree)
  - [F.5:10 - Micro‑examples (illustrative)](#f510---microexamples-illustrative)
  - [F.5:11 - Anti‑patterns & remedies](#f511---antipatterns-remedies)
  - [F.5:12 - Worked examples](#f512---worked-examples)
  - [F.5:13 - Migration notes (conceptual)](#f513---migration-notes-conceptual)
  - [F.5:14 - Acceptance tests (SCR/RSCR — concept‑level)](#f514---acceptance-tests-scrrscr-conceptlevel)
  - [F.5:15 - Didactic distillation (60‑second recap)](#f515---didactic-distillation-60second-recap)
  - [F.5:End](#f5end)
- [F.6 - Role Assignment & Enactment Cycle (Six-Step)](#f6---role-assignment-enactment-cycle-six-step)
  - [F.6:1 - Intent & applicability](#f61---intent-applicability)
  - [F.6:2 - Problem frame](#f62---problem-frame)
  - [F.6:3 - Forces](#f63---forces)
  - [F.6:4 - Minimal vocabulary (this pattern only)](#f64---minimal-vocabulary-this-pattern-only)
  - [F.6:5 - Pre‑conditions (lightweight)](#f65---preconditions-lightweight)
  - [F.6:6 - The six moves (judgement schemas, notation‑free)](#f66---the-six-moves-judgement-schemas-notationfree)
  - [F.6:7 - Core invariants (normative)](#f67---core-invariants-normative)
  - [F.6:8 - Reasoning aides (didactic)](#f68---reasoning-aides-didactic)
  - [F.6:9 - Anti‑patterns & remedies](#f69---antipatterns-remedies)
  - [F.6:10 - Worked examples](#f610---worked-examples)
  - [F.6:11 - Relations (with other patterns)](#f611---relations-with-other-patterns)
  - [F.6:12 - Migration notes (conceptual)](#f612---migration-notes-conceptual)
  - [F.6:13 - Acceptance tests (SCR/RSCR — concept‑level)](#f613---acceptance-tests-scrrscr-conceptlevel)
  - [F.6:14 - Didactic distillation (60‑second recap)](#f614---didactic-distillation-60second-recap)
  - [F.6:End](#f6end)
- [F.7 - Concept‑Set Table](#f7---conceptset-table)
  - [F.7:1 - Intent & applicability](#f71---intent-applicability)
  - [F.7:2 - Problem frame](#f72---problem-frame)
  - [F.7:3 - Forces](#f73---forces)
  - [F.7:4 - Core idea (didactic)](#f74---core-idea-didactic)
  - [F.7:5 - Minimal vocabulary (this pattern only)](#f75---minimal-vocabulary-this-pattern-only)
  - [F.7:6 - The table (conceptual layout)](#f76---the-table-conceptual-layout)
  - [F.7:7 - Conceptual construction (thought moves, not workflow)](#f77---conceptual-construction-thought-moves-not-workflow)
  - [F.7:8 - Invariants (normative)](#f78---invariants-normative)
  - [F.7:9 - Micro‑illustrations (safe patterns)](#f79---microillustrations-safe-patterns)
  - [F.7:10 - Anti‑patterns & remedies](#f710---antipatterns-remedies)
  - [F.7:11 - Worked examples](#f711---worked-examples)
  - [F.7:12 - Reasoning primitives (judgement schemas, notation‑free)](#f712---reasoning-primitives-judgement-schemas-notationfree)
  - [F.7:13 - Relations (with other patterns)](#f713---relations-with-other-patterns)
  - [F.7:14 - Migration notes (conceptual)](#f714---migration-notes-conceptual)
  - [F.7:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f715---acceptance-tests-scrrscr-conceptlevel)
  - [F.7:16 - Didactic distillation (60‑second teaching script)](#f716---didactic-distillation-60second-teaching-script)
  - [F.7:End](#f7end)
- [F.8 - Mint or Reuse? (U.Type vs Concept-Set vs Role Description vs Alias)](#f8---mint-or-reuse-utype-vs-concept-set-vs-role-description-vs-alias)
  - [F.8:1 - Intent & applicability](#f81---intent-applicability)
  - [F.8:2 - Problem frame](#f82---problem-frame)
  - [F.8:3 - Forces](#f83---forces)
  - [F.8:4 - Minimal vocabulary (used in this pattern only)](#f84---minimal-vocabulary-used-in-this-pattern-only)
  - [F.8:5 - The decision lattice (conceptual, notation‑free)](#f85---the-decision-lattice-conceptual-notationfree)
  - [F.8:6 - Scope thresholds (default τ) — **how much sameness** you’re allowed to claim](#f86---scope-thresholds-default-how-much-sameness-youre-allowed-to-claim)
  - [F.8:7 - Micro‑examples (didactic triad)](#f87---microexamples-didactic-triad)
  - [F.8:8 - Invariants (normative, lightweight)](#f88---invariants-normative-lightweight)
  - [F.8:8.1 - Mint/Reuse discipline for **policy-ids** (normative addendum)](#f881---mintreuse-discipline-for-policy-ids-normative-addendum)
  - [F.8:9 - Quick reference (one‑glance map)](#f89---quick-reference-oneglance-map)
  - [F.8:10 - Anti‑patterns & remedies](#f810---antipatterns-remedies)
  - [F.8:11 - Reasoning primitives (judgement schemas, notation‑free)](#f811---reasoning-primitives-judgement-schemas-notationfree)
  - [F.8:12 - Extended worked examples](#f812---extended-worked-examples)
  - [F.8:13 - Relations (with other patterns)](#f813---relations-with-other-patterns)
  - [F.8:14 - Migration notes (conceptual)](#f814---migration-notes-conceptual)
  - [F.8:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f815---acceptance-tests-scrrscr-conceptlevel)
  - [F.8:16 - Didactic distillation (90‑second teaching script)](#f816---didactic-distillation-90second-teaching-script)
  - [F.8:End](#f8end)
- [F.9 - Alignment & Bridge across Contexts](#f9---alignment-bridge-across-contexts)
  - [F.9:1 - Intent & applicability](#f91---intent-applicability)
  - [F.9:2 - Problem frame](#f92---problem-frame)
  - [F.9:3 - Forces](#f93---forces)
  - [F.9:4 - Core idea (didactic)](#f94---core-idea-didactic)
  - [F.9:5 - Minimal vocabulary (this pattern only)](#f95---minimal-vocabulary-this-pattern-only)
  - [F.9:6 - Bridge kinds (senseFamily-aware)](#f96---bridge-kinds-sensefamily-aware)
  - [F.9:7 - CL scale and scope thresholds](#f97---cl-scale-and-scope-thresholds)
  - [F.9:8 - The Bridge Card (compact sketch)](#f98---the-bridge-card-compact-sketch)
  - [F.9:9 - Invariants (normative)](#f99---invariants-normative)
  - [F.9:10 - Micro-examples (illustrative, one-liners)](#f910---micro-examples-illustrative-one-liners)
  - [F.9:11 - Anti-patterns & remedies](#f911---anti-patterns-remedies)
  - [F.9:12 - Worked examples (didactic)](#f912---worked-examples-didactic)
  - [F.9:13 - Reasoning primitives (judgement schemas)](#f913---reasoning-primitives-judgement-schemas)
  - [F.9:14 - Relations](#f914---relations)
  - [F.9:15 - Migration notes (conceptual)](#f915---migration-notes-conceptual)
  - [F.9:16 - Acceptance tests (SCR/RSCR — concept-level)](#f916---acceptance-tests-scrrscr-concept-level)
  - [F.9:17 - Didactic distillation (90-second script)](#f917---didactic-distillation-90-second-script)
  - [F.9:18 - Archetypal Grounding](#f918---archetypal-grounding)
  - [F.9:19 - Bias-Annotation](#f919---bias-annotation)
  - [F.9:20 - Conformance Checklist (CC-F.9)](#f920---conformance-checklist-cc-f9)
  - [F.9:21 - Consequences](#f921---consequences)
  - [F.9:22 - Rationale](#f922---rationale)
  - [F.9:23 - SoTA-Echoing](#f923---sota-echoing)
  - [F.9:24 - Bridge Card Publication Discipline](#f924---bridge-card-publication-discipline)
  - [F.9:25 - Bundle and Endpoint Interaction Law](#f925---bundle-and-endpoint-interaction-law)
  - [F.9:26 - Review Matrix and Migration Tests](#f926---review-matrix-and-migration-tests)
  - [F.9:End](#f9end)
- [F.9.1 - Bridge Stance Overlay](#f91---bridge-stance-overlay)
  - [F.9.1:1 - Problem frame](#f911---problem-frame)
  - [F.9.1:2 - Problem](#f912---problem)
  - [F.9.1:3 - Forces](#f913---forces)
  - [F.9.1:4 - Solution](#f914---solution)
  - [F.9.1:5 - Archetypal Grounding](#f915---archetypal-grounding)
  - [F.9.1:6 - Bias-Annotation](#f916---bias-annotation)
  - [F.9.1:7 - Conformance Checklist](#f917---conformance-checklist)
  - [F.9.1:8 - Common Anti-Patterns and How to Avoid Them](#f918---common-anti-patterns-and-how-to-avoid-them)
  - [F.9.1:9 - Consequences](#f919---consequences)
  - [F.9.1:10 - Rationale](#f9110---rationale)
  - [F.9.1:11 - SoTA-Echoing](#f9111---sota-echoing)
  - [F.9.1:12 - Relations](#f9112---relations)
  - [F.9.1:13 - Worked Bridge-Card Examples](#f9113---worked-bridge-card-examples)
  - [F.9.1:14 - Authoring and Review Guidance](#f9114---authoring-and-review-guidance)
  - [F.9.1:15 - Migration and Boundary Notes](#f9115---migration-and-boundary-notes)
  - [F.9.1:16 - Overlay Package Discipline](#f9116---overlay-package-discipline)
  - [F.9.1:17 - Interaction with `CL`, Direction, and Loss](#f9117---interaction-with-cl-direction-and-loss)
  - [F.9.1:18 - Bundle Use and Comparative Reading](#f9118---bundle-use-and-comparative-reading)
  - [F.9.1:19 - Review Matrix and Migration Tests](#f9119---review-matrix-and-migration-tests)
  - [F.9.1:End](#f91end)
- [F.10 - Status Families Mapping (Evidence • Standard • Requirement)](#f10---status-families-mapping-evidence-standard-requirement)
  - [F.10:1 - Intent & applicability](#f101---intent-applicability)
  - [F.10:2 - Problem frame](#f102---problem-frame)
  - [F.10:3 - Forces](#f103---forces)
  - [F.10:4 - Core idea (didactic)](#f104---core-idea-didactic)
  - [F.10:5 - Minimal vocabulary (this pattern only)](#f105---minimal-vocabulary-this-pattern-only)
  - [F.10:6 - The spine: three local ladders (Context‑native, small and renameable)](#f106---the-spine-three-local-ladders-contextnative-small-and-renameable)
  - [F.10:7 - Solution — how meanings connect (conceptual, notation‑free)](#f107---solution-how-meanings-connect-conceptual-notationfree)
  - [F.10:8 - Invariants (normative, lightweight)](#f108---invariants-normative-lightweight)
  - [F.10:9 - Micro‑illustrations (snapshots, not procedures)](#f109---microillustrations-snapshots-not-procedures)
  - [F.10:10 - Anti‑patterns & remedies](#f1010---antipatterns-remedies)
  - [F.10:11 - Worked examples](#f1011---worked-examples)
  - [F.10:12 - Reasoning primitives (judgement schemas, notation‑free)](#f1012---reasoning-primitives-judgement-schemas-notationfree)
  - [F.10:13 - Relations](#f1013---relations)
  - [F.10:14 - Migration notes (conceptual)](#f1014---migration-notes-conceptual)
  - [F.10:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f1015---acceptance-tests-scrrscr-conceptlevel)
  - [F.10:16 - Didactic distillation (90‑second script)](#f1016---didactic-distillation-90second-script)
  - [F.10:End](#f10end)
- [F.11 - Method Quartet Harmonisation](#f11---method-quartet-harmonisation)
  - [F.11:1 - Intent & applicability](#f111---intent-applicability)
  - [F.11:2 - Problem frame](#f112---problem-frame)
  - [F.11:3 - Forces](#f113---forces)
  - [F.11:4 - Core idea (didactic)](#f114---core-idea-didactic)
  - [F.11:5 - Minimal vocabulary (this pattern only)](#f115---minimal-vocabulary-this-pattern-only)
  - [F.11:6 - Solution — the quartet lens (notation‑free)](#f116---solution-the-quartet-lens-notationfree)
  - [F.11:7 - Harmonisation map (Context‑first)](#f117---harmonisation-map-contextfirst)
  - [F.11:8 - Invariants (normative)](#f118---invariants-normative)
  - [F.11:9 - Micro‑examples (didactic)](#f119---microexamples-didactic)
  - [F.11:10 - Anti‑patterns & remedies](#f1110---antipatterns-remedies)
  - [F.11:11 - Worked examples (extended)](#f1111---worked-examples-extended)
  - [F.11:12 - Reasoning primitives (judgement schemas)](#f1112---reasoning-primitives-judgement-schemas)
  - [F.11:13 - Relations](#f1113---relations)
  - [F.11:14 - Migration notes (conceptual)](#f1114---migration-notes-conceptual)
  - [F.11:15 - Acceptance tests (SCR/RSCR — concept level)](#f1115---acceptance-tests-scrrscr-concept-level)
  - [F.11:16 - Didactic distillation (90‑second script)](#f1116---didactic-distillation-90second-script)
  - [F.11:End](#f11end)
- [F.12 — Service Acceptance–Work Evidence Link](#f12-service-acceptancework-evidence-link)
  - [F.12:1 - Intent & applicability](#f121---intent-applicability)
  - [F.12:2 - Problem frame](#f122---problem-frame)
  - [F.12:3 - Forces](#f123---forces)
  - [F.12:4 - Core idea (didactic)](#f124---core-idea-didactic)
  - [F.12:5 - Minimal vocabulary (this pattern only)](#f125---minimal-vocabulary-this-pattern-only)
  - [F.12:6 - The binding, as five mental rules (notation‑free)](#f126---the-binding-as-five-mental-rules-notationfree)
  - [F.12:7 - Clause templates (conceptual schemata)](#f127---clause-templates-conceptual-schemata)
  - [F.12:8 - Invariants (normative)](#f128---invariants-normative)
  - [F.12:9 - Micro‑examples (didactic, multi‑domain)](#f129---microexamples-didactic-multidomain)
  - [F.12:10 - Anti‑patterns & remedies](#f1210---antipatterns-remedies)
  - [F.12:11 - Extended worked examples](#f1211---extended-worked-examples)
  - [F.12:12 - Reasoning primitives (judgement schemas, notation‑free)](#f1212---reasoning-primitives-judgement-schemas-notationfree)
  - [F.12:13 - Relations (with other patterns)](#f1213---relations-with-other-patterns)
  - [F.12:14 - Migration notes (conceptual)](#f1214---migration-notes-conceptual)
  - [F.12:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f1215---acceptance-tests-scrrscr-conceptlevel)
  - [F.12:End](#f12end)
- [F.13 - Lexical Continuity & Deprecation](#f13---lexical-continuity-deprecation)
  - [F.13:1 - Intent & applicability](#f131---intent-applicability)
  - [F.13:2 - Problem frame](#f132---problem-frame)
  - [F.13:3 - Forces](#f133---forces)
  - [F.13:4 - Core idea (didactic)](#f134---core-idea-didactic)
  - [F.13:5 - Minimal vocabulary (this pattern only)](#f135---minimal-vocabulary-this-pattern-only)
  - [F.13:6 - Solution — Continuity, not “registries”](#f136---solution-continuity-not-registries)
  - [F.13:7 - Invariants (normative)](#f137---invariants-normative)
  - [F.13:8 - Self‑checks (mental, not procedural)](#f138---selfchecks-mental-not-procedural)
  - [F.13:9 - Micro‑examples (illustrative)](#f139---microexamples-illustrative)
  - [F.13:10 - Anti‑patterns & remedies](#f1310---antipatterns-remedies)
  - [F.13:11 - Extended examples](#f1311---extended-examples)
  - [F.13:12 - Reasoning primitives (judgement schemas, notation‑free)](#f1312---reasoning-primitives-judgement-schemas-notationfree)
  - [F.13:13 - Relations](#f1313---relations)
  - [F.13:14 - Migration notes (conceptual playbook)](#f1314---migration-notes-conceptual-playbook)
  - [F.13:15 - Acceptance tests (SCR/RSCR — concept‑level)](#f1315---acceptance-tests-scrrscr-conceptlevel)
  - [F.13:16 - Didactic distillation (60‑second script)](#f1316---didactic-distillation-60second-script)
  - [F.13:End](#f13end)
- [F.14 - Anti‑Explosion Control (Roles & Statuses)](#f14---antiexplosion-control-roles-statuses)
  - [F.14:1 - Intent & applicability](#f141---intent-applicability)
  - [F.14:2 - Problem frame](#f142---problem-frame)
  - [F.14:3 - Forces](#f143---forces)
  - [F.14:4 - Minimal vocabulary (this pattern only)](#f144---minimal-vocabulary-this-pattern-only)
  - [F.14:5 - Core idea (didactic)](#f145---core-idea-didactic)
  - [F.14:6 - Solution — the control cabinet (conceptual, notation‑free)](#f146---solution-the-control-cabinet-conceptual-notationfree)
  - [F.14:7 - Invariants (normative)](#f147---invariants-normative)
  - [F.14:8 - Reasoning primitives (judgement schemas)](#f148---reasoning-primitives-judgement-schemas)
  - [F.14:9 - Micro‑examples (engineer / manager / researcher lenses)](#f149---microexamples-engineer-manager-researcher-lenses)
  - [F.14:10 - Anti‑patterns & remedies](#f1410---antipatterns-remedies)
  - [F.14:11 - Worked examples](#f1411---worked-examples)
  - [F.14:12 - Relations (with other patterns)](#f1412---relations-with-other-patterns)
  - [F.14:13 - Migration notes (conceptual playbook)](#f1413---migration-notes-conceptual-playbook)
  - [F.14:14 - Acceptance tests (SCR/RSCR — concept‑level)](#f1414---acceptance-tests-scrrscr-conceptlevel)
  - [F.14:15 - Didactic distillation (90‑second script)](#f1415---didactic-distillation-90second-script)
  - [F.14:End](#f14end)
- [F.15 - SCR/RSCR Harness for Unification](#f15---scrrscr-harness-for-unification)
  - [F.15:1 - Intent & applicability](#f151---intent-applicability)
  - [F.15:2 - Problem frame](#f152---problem-frame)
  - [F.15:3 - Forces](#f153---forces)
  - [F.15:4 - Core idea (didactic)](#f154---core-idea-didactic)
  - [F.15:5 - Minimal vocabulary (this pattern only)](#f155---minimal-vocabulary-this-pattern-only)
  - [F.15:6 - Objects under check](#f156---objects-under-check)
  - [F.15:7 - Solution overview — the harness as a lattice of checks](#f157---solution-overview-the-harness-as-a-lattice-of-checks)
  - [F.15:8 - SCR — Static conformance rules (S‑Local)](#f158---scr-static-conformance-rules-slocal)
  - [F.15:9 - SCR — Static conformance rules (S‑Cross)](#f159---scr-static-conformance-rules-scross)
  - [F.15:10 - Judgement schemas (core moves)](#f1510---judgement-schemas-core-moves)
  - [F.15:11 - Micro‑witnesses (illustrative)](#f1511---microwitnesses-illustrative)
  - [F.15:12 - Relations (with other patterns)](#f1512---relations-with-other-patterns)
  - [F.15:13 - RSCR — Regression & Stability Rules (R‑Evo)](#f1513---rscr-regression-stability-rules-revo)
  - [F.15:14 - Anti‑patterns the harness catches (and the fix)](#f1514---antipatterns-the-harness-catches-and-the-fix)
  - [F.15:15 - Worked “dry‑runs” (composite slices)](#f1515---worked-dryruns-composite-slices)
  - [F.15:16 - Migration cues (conceptual)](#f1516---migration-cues-conceptual)
  - [F.15:17 - Acceptance summary (“Harness green”)](#f1517---acceptance-summary-harness-green)
  - [F.15:18 - Didactic distillation (90‑second teaching script)](#f1518---didactic-distillation-90second-teaching-script)
  - [F.15:End](#f15end)
- [F.16 - Worked‑Example Template (Cross‑Domain)](#f16---workedexample-template-crossdomain)
  - [F.16:1 - Intent & applicability](#f161---intent-applicability)
  - [F.16:2 - Problem frame](#f162---problem-frame)
  - [F.16:3 - Core idea (didactic)](#f163---core-idea-didactic)
  - [F.16:4 - Minimal vocabulary (this pattern only)](#f164---minimal-vocabulary-this-pattern-only)
  - [F.16:5 - The one‑page **Worked‑Example Canvas**](#f165---the-onepage-workedexample-canvas)
  - [F.16:6 - Invariants (normative)](#f166---invariants-normative)
  - [F.16:7 - The row panel (how to show it without notation)](#f167---the-row-panel-how-to-show-it-without-notation)
  - [F.16:8 - Worked micro‑example (didactic)](#f168---worked-microexample-didactic)
  - [F.16:9 - Relations (with other patterns)](#f169---relations-with-other-patterns)
  - [F.16:10 - Didactic distillation (60‑second script)](#f1610---didactic-distillation-60second-script)
  - [F.16:11 - Anti‑patterns & remedies](#f1611---antipatterns-remedies)
  - [F.16:12 - Extended worked micro‑examples](#f1612---extended-worked-microexamples)
  - [F.16:13 - Reasoning primitives (judgement schemas)](#f1613---reasoning-primitives-judgement-schemas)
  - [F.16:14 - Acceptance tests (SCR/RSCR)](#f1614---acceptance-tests-scrrscr)
  - [F.16:15 - Migration notes (conceptual)](#f1615---migration-notes-conceptual)
  - [F.16:16 - Teaching variants (all obey §6 invariants)](#f1616---teaching-variants-all-obey-6-invariants)
  - [F.16:17 - Didactic checklist (author’s quick scan)](#f1617---didactic-checklist-authors-quick-scan)
  - [F.16:18 - Closing distillation (30‑second echo)](#f1618---closing-distillation-30second-echo)
  - [F.16:End](#f16end)
- [F.17 - Unified Term Sheet (UTS)](#f17---unified-term-sheet-uts)
  - [F.17:1 - Intent & Applicability](#f171---intent-applicability)
  - [F.17:2 - Problem Frame](#f172---problem-frame)
  - [F.17:3 - Forces](#f173---forces)
  - [F.17:4 - Core Idea](#f174---core-idea)
  - [F.17:5 - Minimal Vocabulary (for this pattern)](#f175---minimal-vocabulary-for-this-pattern)
  - [F.17:6 - Row Schema (normative)](#f176---row-schema-normative)
  - [F.17:7 - Block Plan (didactic grouping)](#f177---block-plan-didactic-grouping)
  - [F.17:8 - Column Families (two canonical layouts)](#f178---column-families-two-canonical-layouts)
  - [F.17:9 - Invariants (normative constraints)](#f179---invariants-normative-constraints)
  - [F.17:10 - How to Compile (conceptual moves, not a workflow)](#f1710---how-to-compile-conceptual-moves-not-a-workflow)
  - [F.17:11 - Acceptance Harness (SCR/RSCR) for a UTS](#f1711---acceptance-harness-scrrscr-for-a-uts)
  - [F.17:12 - Canonical Heading Templates (fill with your Contexts/Discipline columns)](#f1712---canonical-heading-templates-fill-with-your-contextsdiscipline-columns)
